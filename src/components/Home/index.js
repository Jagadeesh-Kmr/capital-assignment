...
class Home extends Component {
  ...
  renderYesOrNOBoxView = () => {
    const {yesOrNoInput, yesOrNoText} = this.state

    const onClickDeleteText = () => this.setState({yesOrNoText: ''})
  ...
  renderParagraphBoxView = () => {
    ...
    const onClickDeleteText = () => this.setState({paragraphText: ''})
